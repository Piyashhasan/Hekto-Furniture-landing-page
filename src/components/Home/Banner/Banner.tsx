import bannerImg from "../../../assets/image/banner-sofa.png";
import lampImg from "../../../assets/image/lamp.png";
import dotImg from "../../../assets/image/dot.png";
    ...
    <main className="w-full bg-[#F2F0FF]">
      <div className="wrapper relative py-[55px]">
        ...
        <div className="hidden xl:block xl:absolute xl:top-0 xl:left-[-70px] 2xl:left-[-80px] xl:z-10">
          <img className="max-w-[280px]" src={lampImg} alt="lamp image" />
        </div>
